...
import { CAREER_FAQS } from "@/lib/constants";
...
export default function FAQ() {
  ...
  return (
    <section className="bg-accent dark:bg-ink py-24 overflow-hidden">
      <div className="absolute left-1/2 -translate-x-1/2 top-0 w-[600px] h-[200px] rounded-full bg-primary-500/8 blur-[80px] pointer-events-none" />
            ...
            return (
              <motion.div
                ...
                className={cn(
                  ...
                  isOpen
                    ? "border-primary-400/30 bg-primary-50 dark:bg-primary-800"
                    : "border-gray-200 dark:border-primary-700/40 bg-white dark:bg-primary-900 hover:border-primary-200 dark:hover:border-primary-600/50"
                )}
              >
                <button
                ...
                >
                  <span className="font-heading font-semibold text-ink dark:text-white text-sm md:text-base">
                    {faq.question}
                  </span>
