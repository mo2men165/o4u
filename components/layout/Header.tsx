        ...
        {mobileOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 w-80 max-w-[85vw] bg-white dark:bg-primary-900 border-l border-black/8 dark:border-white/8 shadow-2xl z-50 lg:hidden overflow-y-auto"
            >
